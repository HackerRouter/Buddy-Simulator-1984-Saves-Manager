...
namespace $safeprojectname$
{
    class Program
    {
        ...
        public class values
        {
            ...
            public static bool foundHiddenROM = false;
...
");
                        break;
                    case ("view roms"):
                        if (Program.values.foundHiddenROM == false)
                        {
                            textRenderer(@"
INSTALLED ROMS
--------------
...
");
                    ...
                    case ("run  "):
                        ...
                        {
                            values.foundHiddenROM = true;
                        }
                        if (values.foundHiddenROM == true)
                        {
...
>");
                    ...
                    default:
                        ...
                        else if(commandInput.StartsWith("play"))
                        {
                            ...
                            {
                                string songStart = commandInput.Substring(5);
                                textRenderer($"Song [{songStart}] not found.");
                            }
                        }
                        else
                        {
