...
namespace $safeprojectname$
{
    class BS1984Manager{
        public static void BS1984ManagerThread()
        {
            ...
            Console.Clear();
            Program.textRenderer("[Buddy Simulator 1984 Saves Manager] [Version 1.0.2]\nCreated By HackerRouter\nEnter HELP for more assistance.\n");
            while (true)
            {
...
");
                    ...
                    case ("quit"):
                        break;
                    case "run bs1984":
                        Program.textRenderer("\nReminder: Enter 'Quit BS1984' at any time to quit the game.\n");
                        Process.Start("steam://rungameid/1269950");
                    ...
                    case "quit bs1984":
                        ...
                        Program.textRenderer("\nReminder: You have quitted your game.\n");
                        break;
                    default:
